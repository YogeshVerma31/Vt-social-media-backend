                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="needs-validation" method="POST" enctype="multipart/form-data"
                                        action="{{ route('updateCoupon',$coupon->id) }}">
                                        @csrf

                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="validationCustom01" class="form-label">Coupon
                                                        Name</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="validationCustom01" class="form-label">Coupon Discounted
                                                        (in Percent)</label>
                                                    <input type="text" class="form-control" id="validationCustom01"
                                                        placeholder="Coupon Discounted" name="discount"
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" class="form-control" id="validationCustom01"
                                                        placeholder="Coupon Validity" name="validity"
                                                        value="{{ $coupon->validity }}" required>
                                                </div>
                                            </div>
